...
|---------|-----------|--------|------|--------|
| 市場データ | 開発者ツール市場、コードレビューツール、AI開発支援 | 調査レポート | 月1回 | data/collected/market/ |
| 競合情報 | GitHub Copilot, Cursor, Tabnine, CodeRabbit, Sourcery | 競合サイト | 週1回 | data/collected/competitor/ |
| 技術動向 | Python AST, LLM Code Review, Static Analysis | GitHub、公式ドキュメント | 週1回 | data/collected/tech/ |
| SNSトレンド | #AIコードレビュー #開発効率化 #ペアプログラミング | X/Twitter | 日1回 | data/collected/social/ |
| 法規制 | ソフトウェア著作権、AI生成コード利用規約 | 官公庁サイト | 月1回 | data/collected/legal/ |
...
|-----------------|-----------|------|------|
| X/Twitter | @DevBuddyAI | 開発者向け技術Tips・製品告知 | 要開設 |

### 投稿スケジュール
| 曜日 | 時間 | コンテンツタイプ |
|------|------|-----------------|
| 月-金 | 09:00, 18:00 | 価値提供投稿（コードレビューTips、開発効率化） |
| 土日 | 12:00 | 週間まとめ |
